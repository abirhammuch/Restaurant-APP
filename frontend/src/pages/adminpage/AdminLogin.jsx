...
const AdminLogin = () => {
  const { navigate, backendUrl, setAdmintoken, setIsAdmin, isAdmin } =
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gray-50 px-4 sm:px-6">
      <div className="shadow-lg px-6 sm:px-10 lg:px-12 py-8 sm:py-9 rounded-2xl bg-white w-full max-w-md">
